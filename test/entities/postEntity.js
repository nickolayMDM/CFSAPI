...
const PostTest = (
    ...
    testDescribe("Post Entity Test", () => {
        ...
        const fullBuildParameters = {
            ...
            imageUrl: "https://p16-sign-sg.tiktokcdn.com/obj/tos-alisg-p-0037/919dbd43723943f8b003dd5d134505e0?x-expires=1631383200&x-signature=p1dfLwXOe9%2BXUn856RmFLfNpbFQ%3D",
        ...
        buildIncorrectEntity({
            buildEntity: buildPost,
            testName: "should throw an error when building an entity with an invalid image url",
            buildParameters: {
                ...fullBuildParameters,
                ID,
                imageUrl: "Bob"
        ...
        getFieldFromEntity({
            ID,
            buildEntity: buildPost,
            testName: "should get image URL from entity",
            expectedData: fullBuildParameters.imageUrl,
